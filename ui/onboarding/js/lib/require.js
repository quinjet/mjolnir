...
(function(Z) {
  ...
  function Q(b, c, d, h) {
    c && F(c, function(c, j) {
      if (d || !s(b, j)) h && "string" !== typeof c ? (b[j] || (b[j] = {}), Q(b[j], c, d, h)) : b[j] = c
    });
    return b
  }
  function u(b, c) {
  ...
  function ha(b) {
    function c(a, f, b) {
      ...
      if (a && "." === a.charAt(0)) if (f) {
        ...
        else if (".." === m) if (1 === e && (".." === f[2] || ".." === f[0])) break;
    ...
    function C() {
      ...
      if (!U) {
        ...
        F(T, function(b) {
          a = b.map;
          f = a.id;
          if (b.enabled && (a.isDefine || g.push(b), !b.error)) if (!b.inited && m) h(f) ? j = e = !0 : (c.push(f), d(f));
